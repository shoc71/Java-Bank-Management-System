...
public class SignUpOne extends JFrame {
    ...
    SignUpOne() {
        ...
        JLabel gender = new JLabel("Gender/Sex:");
        ...
        JLabel emailAddress = new JLabel("Email (primary):");
        ...
        JRadioButton otherMarried = new JRadioButton("Other");
        otherMarried.setBounds(600, 390, 100, 30);
        ...
        maritalStatusGroup.add(otherMarried);
